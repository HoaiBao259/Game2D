...
public class AssetSetter {
    ...
    public void setObject(){
        ...
        objSetter(new OBJ_Bones(gp), mapNum, i, 3, 5);i++; objSetter(new OBJ_Door_Iron(gp), mapNum, i, 31, 5);i++;
        ...
        objSetter(new OBJ_Door_Iron(gp), mapNum, i, 9, 45);i++;
        objSetter(new OBJ_Door_Iron(gp), mapNum, i, 39, 45);i++;
